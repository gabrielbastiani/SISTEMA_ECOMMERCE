...
export const VariantManager: React.FC<VariantManagerProps> = ({
    ...
    const [expandedAttributes, setExpandedAttributes] = useState<Record<string, Record<number, boolean>>>({});
                ...
                return (
                    <div key={variantId} className="border rounded-lg p-4">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <h4 className="font-medium text-lg">Variante: {variant.sku || `#${idx + 1}`}</h4>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    >
                                        <Select
                                            ...
                                            items={promoItems}
                                            selectedKeys={variant.mainPromotion_id ? new Set([variant.mainPromotion_id]) : new Set<string>()}
